...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ApolloLibraryAccessors extends SubDependencyFactory {
        private final ApolloGradleLibraryAccessors laccForApolloGradleLibraryAccessors = new ApolloGradleLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>apollo.gradle</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ApolloGradleLibraryAccessors getGradle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForApolloGradleLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ApolloGradleLibraryAccessors extends SubDependencyFactory {

        public ApolloGradleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>plugin</b> with <b>com.apollographql.apollo:apollo-gradle-plugin</b> coordinates and
         * with version reference <b>apolloGradlePlugin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getPlugin() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("apollo.gradle.plugin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>apolloGradlePlugin</b> with value <b>1.0.0)</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getApolloGradlePlugin() { return getVersion("apolloGradlePlugin"); }

        /**
         * Version alias <b>apolloRuntime</b> with value <b>3.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
